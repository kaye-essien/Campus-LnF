...
if (!$user) {
    ...
    if (strlen($pw) < 6) {
        ...
        $upd  = $conn->prepare("UPDATE users SET password=?, reset_token=NULL, reset_expires=NULL, verified=1 WHERE id=?");
    ...
    <div class="auth-box" style="max-width:440px">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="password" name="password" placeholder="Min 6 characters" required oninput="checkStrength(this.value)">
